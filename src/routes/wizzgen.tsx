...
function WizzGenPage() {
  return (
    <GamingPage
      eyebrow="A different kind of Bedrock world"
    ...
    >
      <section className="section-block intro-grid" aria-labelledby="wizzgen-about">
        <div className="section-heading">
          ...
          <h2 id="wizzgen-about">Explore beyond the usual seed.</h2>
        </div>
        <div className="intro-copy">
          <p>
            WizzGen MC Bedrock is a separate FFL Team server project designed for players who want
            a twist on familiar survival. Expect evolving ideas, unusual terrain, and experiments
        ...
        <div className="content-grid connection-grid">
          <ContentCard label="Connection sequence">
            <StepList steps={[
              ...
              'Open Play, select Servers, and choose Add Server.',
              'Enter the provided address and port, save, then connect.',
            ]} />
          </ContentCard>
          <ContentCard label="Access details" accent>
            <dl className="server-details">
              <div><dt>Server IP</dt><dd>WIZZGEN.SERVER.IP</dd></div>
      ...
      <section className="section-block" id="rules" aria-labelledby="wizzgen-rules">
        ...
        <div className="rules-grid">
          {[
            ...
            'Listen to project admins when a feature needs testing, resetting, or protecting.',
